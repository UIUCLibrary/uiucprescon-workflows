...
$startMenuName = '[[StartMenuLinkName]]'
...
Install-ChocolateyShortcut `
  -ShortcutFilePath "$Env:ProgramData\Microsoft\Windows\Start Menu\Programs\Speedwagon\$startMenuName.lnk" `
  -TargetPath "$installDir\venv\Scripts\speedwagon.exe" `
  -WorkingDirectory "C:\" `
