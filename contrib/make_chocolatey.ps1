param (
    ...
    [Parameter(Mandatory=$true)] $StartMenuLinkName,
...
choco new -t speedwagon $PackageName packageversion=$PackageVersion PythonSummary="$PackageSummary" StartMenuLinkName="$StartMenuLinkName" InstallerFile=$Wheel MaintainerName="$PackageMaintainer" --outputdirectory packages
